...
const ACTION_CONFIG: Record<string, { label: string; color: string }> = {
  ...
  mcp_add_record: { label: 'Add Record', color: 'bg-teal-500/20 text-teal-400' },
  mcp_query: { label: 'MCP Query', color: 'bg-indigo-500/20 text-indigo-400' },
  mcp_search: { label: 'MCP Search', color: 'bg-violet-500/20 text-violet-400' },
  mcp_update_profile: { label: 'Profile Update', color: 'bg-cyan-500/20 text-cyan-400' },
  mcp_profile_update: { label: 'Profile Update', color: 'bg-cyan-500/20 text-cyan-400' },
  mcp_graph_query: { label: 'Graph Query', color: 'bg-fuchsia-500/20 text-fuchsia-400' },
