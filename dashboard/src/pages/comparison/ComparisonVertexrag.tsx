...
const PAGE = COMPARISON_PAGES.find((p) => p.slug === 'vertexrag')!;

export default function ComparisonVertexrag() {
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title={PAGE.seo.title}
        description={PAGE.seo.description}
        path="/comparison/vertexrag"
      />
      <ComparisonJsonLd
        variant="individual"
        path="/comparison/vertexrag"
        title={PAGE.seo.title}
        description={PAGE.seo.description}
        competitors={[COMPETITORS.vertexrag.name, COMPETITORS.mem0.name]}
      />
      ...
      <ComparisonMatrix
        columns={['epitome', 'vertexrag', 'mem0']}
      ...
      <section className="py-20 sm:py-28 relative">
        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="space-y-12">
            {KEY_DIFFERENCES.vertexrag.map((diff, i) => (
              <motion.div
                key={diff.heading}
