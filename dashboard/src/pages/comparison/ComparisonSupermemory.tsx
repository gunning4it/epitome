...
const PAGE = COMPARISON_PAGES.find((p) => p.slug === 'supermemory')!;

export default function ComparisonSupermemory() {
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title={PAGE.seo.title}
        description={PAGE.seo.description}
        path="/comparison/supermemory"
      />
      <ComparisonJsonLd
        variant="individual"
        path="/comparison/supermemory"
        title={PAGE.seo.title}
        description={PAGE.seo.description}
        competitors={[COMPETITORS.supermemory.name, COMPETITORS.vertexrag.name]}
      />
      ...
      <ComparisonMatrix
        columns={['epitome', 'supermemory', 'vertexrag']}
      ...
      <section className="py-20 sm:py-28 relative">
        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="space-y-12">
            {KEY_DIFFERENCES.supermemory.map((diff, i) => (
              <motion.div
                key={diff.heading}
